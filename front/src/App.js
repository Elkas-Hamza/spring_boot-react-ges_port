...
import ConteneureManagement from './components/management/ConteneureManagement';
    ...
    <Router>
      ...
      <Container sx={{ mt: isAuthenticated ? 4 : 0 }}>
        <Routes>
          ...
          <Route path="/operation/create" element={
            <PrivateRoute>
              <OperationForm />
            </PrivateRoute>
          } />
          <Route path="/operation/edit/:id" element={
            <PrivateRoute>
              <OperationForm />
            </PrivateRoute>
          } />
          <Route path="/operation/:id" element={
            <PrivateRoute>
              <OperationDetails />
            </PrivateRoute>
          } />
          ...
          <Route path="/conteneures/create" element={
            <PrivateRoute requiredRole="ADMIN">
              <ConteneureForm />
            </PrivateRoute>
          } />
          <Route path="/conteneures/add" element={<Navigate to="/conteneures/create" />} />
          <Route path="/conteneures/edit/:id" element={
            <PrivateRoute requiredRole="ADMIN">
              <ConteneureForm />
            </PrivateRoute>
          } />
          <Route path="/conteneures/management" element={
            <PrivateRoute requiredRole="ADMIN">
              <ConteneureManagement />
            </PrivateRoute>
          } />
          <Route path="/conteneures/management/:id" element={
            <PrivateRoute requiredRole="ADMIN">
              <ConteneureManagement />
            </PrivateRoute>
          } />
          <Route path="/conteneure/add" element={<Navigate to="/conteneures/create" />} />
          <Route path="/conteneure/create" element={<Navigate to="/conteneures/create" />} />
          <Route path="/conteneure/edit/:id" element={<Navigate replace to="/conteneures/edit/:id" />} />
          <Route path="/conteneure/:action" element={<Navigate replace to="/conteneures/:action" />} />
          ...
          <Route path="/equipe/create" element={
            <PrivateRoute>
              <EquipeForm />
            </PrivateRoute>
          } />
          ...
          <Route path="/equipe/edit/:id" element={
            <PrivateRoute>
              <EquipeForm />
            </PrivateRoute>
          } />
          ...
          <Route path="/shift/create" element={
            <PrivateRoute requiredRole="ADMIN">
              <ShiftForm />
            </PrivateRoute>
          } />
          ...
          <Route path="/engin/create" element={
            <PrivateRoute requiredRole="ADMIN">
              <EnginForm />
            </PrivateRoute>
          } />
          <Route path="/engin/edit/:id" element={
            <PrivateRoute requiredRole="ADMIN">
              <EnginForm />
            </PrivateRoute>
          } />
          ...
          <Route path="/navire/create" element={
            <PrivateRoute>
              <NavireForm />
            </PrivateRoute>
          } />
          ...
          <Route path="/navire/edit/:id" element={
            <PrivateRoute>
              <NavireForm />
            </PrivateRoute>
          } />
          ...
          {/* Debug Routes */}
          <Route path="/debug/user-role" element={
            <PrivateRoute>
              <UserRoleTest />
            </PrivateRoute>
          } />
