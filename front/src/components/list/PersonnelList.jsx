  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={deleteDialog} onClose={handleCloseDeleteDialog}>
        ...
        <DialogContent>
          <DialogContentText>
            Êtes-vous sûr de vouloir supprimer {personnelToDelete?.nom_personnel} {personnelToDelete?.prenom_personnel} ?
            Cette action est irréversible.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={handleCloseDeleteDialog}>Annuler</Button>
          <Button onClick={handleDeletePersonnel} color="error" variant="contained">
            Supprimer
          </Button>
        </DialogActions>
      </Dialog>
