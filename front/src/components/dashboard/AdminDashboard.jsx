...
const RecentActivityList = () => {
  ...
  const activities = [
    { id: 1, description: 'User admin added a new personnel member', timestamp: '10 minutes ago' },
    { id: 2, description: 'New operation created: Chargement ConteneurMD', timestamp: '2 hours ago' },
    { id: 3, description: 'User hamza modified escale ESC-129', timestamp: '4 hours ago' },
    { id: 4, description: 'New shift assigned to équipe EQP-007', timestamp: '1 day ago' },
    { id: 5, description: 'System backup completed successfully', timestamp: '1 day ago' }
  ];
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const activeEscales = escales.data.filter(escale => 
